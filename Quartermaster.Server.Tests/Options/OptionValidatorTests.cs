...
public class TemplatePreviewRequestValidatorTests {
    ...
    [Test]
    public void EmptyTemplateText_ShouldHaveError() {
        var request = new TemplatePreviewRequest {
            TemplateText = "",
            TemplateModels = "Member"
        };
        ...
        result.ShouldHaveValidationErrorFor(x => x.TemplateText)
            .WithErrorMessage("Vorlagentext darf nicht leer sein.");
    }

    [Test]
    public void EmptyTemplateModels_ShouldHaveNoError() {
        var request = new TemplatePreviewRequest {
            TemplateText = "Hello {{Name}}",
            TemplateModels = ""
        };
        ...
        result.ShouldNotHaveValidationErrorFor(x => x.TemplateModels);
    }
}
